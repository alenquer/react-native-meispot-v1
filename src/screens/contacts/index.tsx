...
import { ObservedContacts } from '../../components/Cards/Contact/observables';
      ...
      <AnimatedHeaderComponent
        ...
        <View style={styles.navigation}>
          ...
          <CustomButton
            ...
            color="white"
            onPress={() => {
              navigation.navigate('contact' as never, {} as never);
            }}
          />
        </View>
        ...
        <View style={styles.listHeader}>
          <Text style={styles.listTitle}>Contatos</Text>
        </View>
      </AnimatedHeaderComponent>
      <ObservedContacts
        table="contacts"
